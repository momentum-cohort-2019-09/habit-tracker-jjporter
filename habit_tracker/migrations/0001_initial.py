# Generated by Django 2.2.7 on 2019-11-07 20:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_complete', models.DateTimeField(default=django.utils.timezone.now)),
                ('habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='entry', to='habit_tracker.Habit')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='habit_tracker.Habit')),
            ],
        ),
    ]
